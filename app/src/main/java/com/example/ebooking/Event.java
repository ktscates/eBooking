...
public class Event {
     ...
     * @param longitude
     */
    public Event(Integer attendingCount, String category, Double cost, Object costMax, String description, String eventSiteUrl, String id, String imageUrl, Integer interestedCount, Boolean isCanceled, Boolean isFree, Boolean isOfficial, Double latitude, Double longitude, String name, Object ticketsUrl, String timeEnd, String timeStart, Location location, String businessId) {
        super();
